@echo off
rem Compila mecanum_car_esp32s3.ino (arduino-cli exige que la carpeta se llame
rem igual que el .ino, asi que este script copia el sketch a .build\ antes de compilar).
setlocal
